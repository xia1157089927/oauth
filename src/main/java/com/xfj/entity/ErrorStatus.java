...
public enum ErrorStatus {
    ...
    /** 验证码错误 */
    ILLEGAL_SOCKET(40005, "非法的socket请求"), SUCCESS(100, "成功"), INVALID_VALID_CODE(400008, "验证码错误"),
    VALIDATOR_DATA_FAULT(-10004, "数据检验不通过"), JPUSH_FAULT(-10005, "消息推送失败"), JPUSH_BATCH_FAULT(-10006, "批量发送消息部分未成功"),
